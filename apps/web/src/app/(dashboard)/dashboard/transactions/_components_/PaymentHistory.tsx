...
import { DataItem } from "@/server/payments";
import { formatDate, formatCurrency, formatSpeed } from "@/lib/utils";

export const PaymentHistory = ({ payments }: { payments: DataItem[] }) => {
  return (
              ...
              <tr key={index}>
                ...
                >
                  <p className="text-dark dark:text-white">
                    {formatSpeed(payment.subscription.package.speed)}
                  </p>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${index === payments.length - 1 ? "border-b-0" : "border-b"}`}
